...
const Sidebar = () => {
   ...
   const [hasUserImage, setrHasUserImage] = useState(false);
   ...
   return (
      <>
         ...
         <aside id="separator-sidebar" className="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
            <div className="h-full px-3 py-4 overflow-y-auto bg-white border-e border-gray-200">
               <ul className="space-y-2 font-medium">
                  <li>
                     <a
                        href="#"
                        className="flex items-center gap-3 px-2 py-1.5 rounded-base
               text-body hover:bg-neutral-tertiary hover:text-fg-brand group"
                     >
                        <LogoSVG />
                     </a>
                  </li>
          ...
          rounded-base text-body
          hover:bg-neutral-tertiary hover:text-fg-brand
          transition
        "
                        >
                           {/* User Image */}
                           <div className="w-8 h-8 rounded-full overflow-hidden border border-default bg-neutral-secondary-soft flex items-center justify-center">
                              {hasUserImage ? (
                                 <Image
                                    src={userImage}
                                    alt="User"
            ...
            bg-neutral-primary shadow-lg z-50
          "
                           >
                              <ul className="py-1 text-sm">
                                 <li>
                                    <a
                                       href="#"
                                       className="block px-4 py-2 hover:bg-neutral-tertiary"
                                    >
                                       Profile
                                    </a>
                                 </li>
                                 ...
                                 <li>
                                    <button
                                       className="w-full text-left px-4 py-2 text-fg-danger hover:bg-danger-soft"
                                    >
                                       Logout
                                    </button>
                                 </li>
